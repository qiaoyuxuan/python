...
"""
    ...
    >>> c = m.bind('example.common', subdomain='kb')
    >>> c.build("static/about")
    ...
    >>> c = m.bind('example.common', '/applications/example')
...
class Map(object):
    ...
    def bind_to_environ(self, environ, server_name=None, subdomain=None):
        ...
        Example: `server_name` is ``'example.common'`` and the `SERVER_NAME`
        in the wsgi `environ` is ``'staging.dev.example.common'`` the calculated
